...
import { loginUser } from '../../redux/userRelated/userHandle'; // Import login action
...
const ParentLoginPage = () => {
    ...
    const role = "Parent"; // Role for parent login
                ...
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    ...
                    >
                        ...
                        <Typography variant="h7">
                            Login to view your child's progress and updates.
                        </Typography>
